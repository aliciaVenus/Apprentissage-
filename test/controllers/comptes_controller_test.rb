...
class ComptesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compte" do
    assert_difference('Compte.count') do
      post comptes_url, params: { compte: { email: @compte.email, nom: @compte.nom, prenom: @compte.prenom, pwd: @compte.pwd, pwdconfirme: @compte.pwdconfirme } }
    end
  ...
  test "should update compte" do
    patch compte_url(@compte), params: { compte: { email: @compte.email, nom: @compte.nom, prenom: @compte.prenom, pwd: @compte.pwd, pwdconfirme: @compte.pwdconfirme } }
